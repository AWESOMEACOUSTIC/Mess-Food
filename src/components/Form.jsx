...
function Form() {
    ...
    return (
        <div className="bg-white w-full px-10 py-7 border-2 border-gray-100 shadow-md">
            ...
            <form onSubmit={handleEmailSignIn} className="mt-8 space-y-4">
                ...
                <div className="flex justify-between items-center">
                    ...
                    <button type="button" className="font-medium w-[3 rem] h-[3 rem] text-base text-white">
                        Forgot password?
                    </button>
                </div>
                <div className="flex justify-center items-center ">
                    <button
                        type="submit"
                        className="w-full text-lg active:scale-95 transition-all p-10 rounded-xl bg-violet-500 text-white  font-bold"
                    >
                        Log In
                    </button>
                </div>
            ...
            <div className="mt-8 flex flex-col gap-y-4">
                <button
                    ...
                    className="w-full flex items-center justify-center rounded-xl py-3 border-2 border-gray-100 active:scale-95 transition-all"
                >
                    <svg
                        className="mr-2"
                        width="24"
            ...
            <div className="mt-8 flex justify-center gap-3 items-center">
                ...
                <button className="text-white text-base font-medium ml-2 bg-white">
                    Sign Up
                </button>
            </div>
        </div>
